          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Button
              ...
              className={`px-8 py-4 text-lg ${
                flipped ? "bg-blue-600 hover:bg-blue-700 text-white" : "bg-gray-300 text-gray-600 cursor-not-allowed pointer-events-none"
              }`}
            >
              Next Card →
            </Button>
      ...
      <div className="mt-16">
        ...
        <div className="space-y-6">
          {flashcards.map((card, idx) => (
            <div key={idx} className="flex justify-between items-center bg-white rounded-lg shadow-md border p-8">
